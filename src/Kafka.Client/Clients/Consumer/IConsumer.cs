...
namespace Kafka.Client.Clients.Consumer
{
        ...
        IClient
    {
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        ValueTask<IStreamReaderApplication<TKey, TValue>> CreateInstance(TopicName topicName, CancellationToken cancellationToken);
        ...
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        ValueTask<IStreamReaderApplication<TKey, TValue>> CreateInstance(IReadOnlySet<TopicName> topicNames, CancellationToken cancellationToken);
        ...
        /// <param name="topicPartitions"></param>
        /// <returns></returns>
        IStreamReaderAssigned<TKey, TValue> Assign(TopicPartition topicPartition);
        ...
        /// <param name="topicPartitions"></param>
        /// <returns></returns>
        IStreamReaderAssigned<TKey, TValue> Assign(IReadOnlySet<TopicPartition> topicPartitions);
    }
}
