...
namespace Kafka.Client.Messages.Encoding
{
    ...
    internal class DescribeAclsRequestEncoder : 
        RequestEncoder<RequestHeaderData, DescribeAclsRequestData>
    {
        internal DescribeAclsRequestEncoder() :
            base(
                ApiKey.DescribeAcls,
                new(0, 3),
                new(2, 32767),
        ...
        protected override EncodeValue<DescribeAclsRequestData> GetMessageEncoder(short apiVersion) =>
            apiVersion switch
            {
                0 => WriteV0,
                1 => WriteV1,
        ...
        ;
        private static int WriteV0([NotNull] in byte[] buffer, in int index, [NotNull] in DescribeAclsRequestData message)
        {
            var i = index;
        ...
        private static int WriteV1([NotNull] in byte[] buffer, in int index, [NotNull] in DescribeAclsRequestData message)
        {
            var i = index;
            i = BinaryEncoder.WriteInt8(buffer, i, message.ResourceTypeFilterField);
            i = BinaryEncoder.WriteNullableString(buffer, i, message.ResourceNameFilterField);
        ...
        private static int WriteV2([NotNull] in byte[] buffer, in int index, [NotNull] in DescribeAclsRequestData message)
        {
            var i = index;
            i = BinaryEncoder.WriteInt8(buffer, i, message.ResourceTypeFilterField);
        ...
        private static int WriteV3([NotNull] in byte[] buffer, in int index, [NotNull] in DescribeAclsRequestData message)
        {
            var i = index;
            i = BinaryEncoder.WriteInt8(buffer, i, message.ResourceTypeFilterField);
            i = BinaryEncoder.WriteCompactNullableString(buffer, i, message.ResourceNameFilterField);
