...
namespace Kafka.Client.Messages.Serdes
{
        ...
        RequestEncoder<RequestHeaderData, ListGroupsRequestData>
    {
        ...
        protected override EncodeDelegate<ListGroupsRequestData> GetMessageEncoder(short apiVersion) =>
            apiVersion switch
            {
                0 => WriteV0,
                1 => WriteV1,
        ...
        ;
        private static int WriteV0(byte[] buffer, int index, ListGroupsRequestData message)
        {
            return index;
        }
        private static int WriteV1(byte[] buffer, int index, ListGroupsRequestData message)
        {
            return index;
        }
        private static int WriteV2(byte[] buffer, int index, ListGroupsRequestData message)
        {
            return index;
        }
        private static int WriteV3(byte[] buffer, int index, ListGroupsRequestData message)
        {
        ...
        private static int WriteV4(byte[] buffer, int index, ListGroupsRequestData message)
        {
