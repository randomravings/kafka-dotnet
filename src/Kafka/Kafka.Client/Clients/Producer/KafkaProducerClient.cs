...
namespace Kafka.Client.Clients.Producer
{
        ...
        IProducer<TKey, TValue>
    {
        ...
        {
            var connection = new TcpConnection(producerPartitionMetadata.Host, producerPartitionMetadata.Port);
        ...
        )
        {
            ...
            if (enableIdempotence)
                (producerId, producerEpoch) = await KafkaProducerClient<TKey, TValue>.GetProducerInstance(
                    protocol,
                    transactionalId,
                    transactionTimeoutMs,
                    producerId,
