...
namespace Kafka.Client.Messages.Extensions
{
    ...
    public static class IncrementalAlterConfigsResponseExtensions
    {
        public static void Write(this IncrementalAlterConfigsResponse message, MemoryStream buffer)
        {
